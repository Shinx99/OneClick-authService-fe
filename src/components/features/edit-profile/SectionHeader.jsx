...
const SectionHeader = ({ title, onAdd }) => {
  return (
    <div className="flex justify-between items-center py-4 border-b border-card-border mb-6 transition-all group">
      <h3 className="text-lg font-black text-text-main flex items-center gap-3 tracking-tight">
