...
const benefits = [
  { icon: MdOutlineLaptopMac, label: "Trang thiết bị", desc: "MacBook & thiết bị mới nhất", color: "bg-emerald-50 text-emerald-600" },
  { icon: MdOutlineLocalHospital, label: "Bảo hiểm cao cấp", desc: "Chi trả 100% bảo hiểm", color: "bg-blue-50 text-blue-600" },
  { icon: MdOutlineFastfood, label: "Đồ ăn miễn phí", desc: "Tủ đồ ăn luôn đầy đủ", color: "bg-amber-50 text-amber-600" },
];
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-100 p-6">
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-lg font-bold text-slate-800">Phúc lợi & Đãi ngộ</h3>
        <button className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-emerald-600 border border-emerald-200 rounded-lg hover:bg-emerald-50 transition-all">
          <MdAdd className="w-4 h-4" /> Thêm phúc lợi
        </button>
      </div>
