...
const ForgetPasswordForm = () => {
  ...
  return (
    <div className="w-full max-w-[400px] mx-auto p-8 bg-white dark:bg-[#1e293b] rounded-[30px] shadow-2xl text-center">
      {/* Icon Header */}
      ...
      <h2 className="text-2xl font-black text-slate-800 dark:text-gray-100 mb-2 uppercase">
        Quên Mật Khẩu?
      </h2>
      <p className="text-gray-500 dark:text-gray-400 text-sm mb-8 font-medium px-2">
